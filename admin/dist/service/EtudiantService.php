...
include_once('C:/xampp/htdocs/PhpProject1/admin/dist/classes/Etudiant.php');
...
class EtudiantService implements IDao {
    ...
    public function create($o) {
        ...
        $query = "INSERT INTO Etudiant (`id` ,`id_classe` , `nom`, `prenom`, `ville`, `sexe` ) "
                . "VALUES (NULL ,'" . $o->getClasse() . "', '" . $o->getNom() . "', '" . $o->getPrenom() . "', 
'" . $o->getVille() . "', '" . $o->getSexe() . ",');";
    ...
    public function findAll() {
        ...
        while ($e = $req->fetch(PDO::FETCH_OBJ)) {
            $etds[] = new Etudiant($e->id, $e->nom, $e->prenom, $e->ville, $e->sexe ,$e->id_classe);
        }
        return $etds;
    }
    ...
    public function findById($id) {
        ...
        if ($e = $req->fetch(PDO::FETCH_OBJ)) {
            $etd = new Etudiant($e->id, $e->nom, $e->prenom, $e->ville, $e->sexe ,$e->id_classe);
        }
        return $etd;
    }
